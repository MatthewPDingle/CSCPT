...
from app.models.domain_models import (
    Game, HandHistory, PlayerHandSnapshot, PlayerStats
)
...
class TestHistoryApi:
    ...
    def test_get_game_hand_histories(self, test_client, mock_service, mock_game, mock_hand_history):
    ...
    def test_get_hand_history(self, test_client, mock_service, mock_game, mock_hand_history):
    ...
    def test_get_hand_history_error_handling(self, test_client, mock_service, mock_game):
    ...
    def test_get_player_statistics(self, test_client, mock_service, mock_player_stats):
        ...
        response = test_client.get(f"/history/player/{player_id}/stats?game_id={game_id}")
    ...
    def test_get_player_hands(self, test_client, mock_service, mock_hand_history):
        ...
        response = test_client.get(f"/history/player/{player_id}/hands?game_id={game_id}&limit=5")
