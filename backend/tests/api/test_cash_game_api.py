...
class TestCashGameAPI:
    ...
    def test_rebuy_player_api(self):
        ...
        # Try rebuy
        response = client.post(
            f"/cash-games/{game_id}/players/{player_id}/rebuy",
            json={"amount": 500}
        )
    ...
    def test_top_up_player_api(self):
        ...
        # Try top-up
        response = client.post(
            f"/cash-games/{game_id}/players/{player_id}/topup"
        )
    ...
    def test_cash_out_player_api(self):
        ...
        # Cash out the player
        response = client.post(
            f"/cash-games/{game_id}/players/{player_id}/cashout"
        )
