...
class TestCashGameMechanics:
    ...
    def test_no_limit_betting(self):
        ...
        no_limit_game = PokerGame(
            small_blind=5, big_blind=10, ante=0, betting_structure="no_limit"
        )
        player = Player("player1", "Player 1", 1000, 0)

        # Minimum bet (1 BB)
        assert (
            no_limit_game.validate_bet_for_betting_structure(
                PlayerAction.BET, 10, player
            )
            is True
        )
    ...
    def test_pot_limit_betting(self):
        ...
        pot_limit_game = PokerGame(
            small_blind=5, big_blind=10, ante=0, betting_structure="pot_limit"
        )
        player = Player("player1", "Player 1", 1000, 0)
        ...
        assert (
            pot_limit_game.validate_bet_for_betting_structure(
                PlayerAction.BET, 100, player
            )
            is True
        )
    ...
    def test_fixed_limit_betting(self):
        ...
        fixed_limit_game = PokerGame(
            small_blind=5, big_blind=10, ante=0, betting_structure="fixed_limit"
        )
        player = Player("player1", "Player 1", 1000, 0)
        ...
        assert (
            fixed_limit_game.validate_bet_for_betting_structure(
                PlayerAction.BET, 10, player
            )
            is True
        )
