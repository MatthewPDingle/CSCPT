...
def test_showdown_with_multiple_pots():
    ...
    main_pot_winner = game.hand_winners.get("Main Pot") or game.hand_winners.get("pot_0")
...
def test_split_pot_with_side_pots():
    ...
    # Set up pots
    game.pots = [
        Pot(amount=400, name="Main Pot")  # 100 from each player
    ]
    ...
    main_pot_winners = game.hand_winners.get("Main Pot") or game.hand_winners.get("pot_0")
