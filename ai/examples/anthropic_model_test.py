"""
Test script to verify all Anthropic Claude models with real API calls.

This script tests each supported Anthropic Claude model with a real API call
to ensure they are correctly implemented and operational.

To use this script:
1. Set your Anthropic API key in the .env file or as an environment variable
2. Run this script
"""
...
async def test_model(model_name):
    """Test a specific Anthropic model with a real API call."""
...
async def test_json_response(model_name):
    """Test a specific Anthropic model's JSON capabilities with a real API call."""
    api_key = os.environ.get("ANTHROPIC_API_KEY")
...
async def test_extended_thinking(model_name):
    """Test a specific Anthropic model's extended thinking capabilities."""
    api_key = os.environ.get("ANTHROPIC_API_KEY")
...
async def main():
    """Run tests for all Anthropic models."""
    logger.info("Starting Anthropic model tests")
