"""
Example demonstrating how to use the OpenAI provider with the LLM service.
"""
...
async def main():
    """Example of using the LLM service with OpenAI provider."""
    ...
    # Example 1: Simple text completion with GPT-4o
    ...
    logger.info("Asking about poker strategies with GPT-4o...")
    ...
    logger.info("Asking for a poker decision with OpenAI...")
